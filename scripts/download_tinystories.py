...
tokenizer = AutoTokenizer.from_pretrained('../olmo_data/tokenizers/tinystories-1k')  # Replace with your model's tokenizer
...
np.save('/n/holyscratch01/sham_lab/summer_2024/datasets/tinystories-vocab-1k-length-1024/input_ids.npy', input_ids)